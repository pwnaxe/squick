...
| ------- | ------------ | ----------------------- |
| Linux   | x86_64       | `@squick/linux-x64`     |
| Linux   | aarch64      | `@squick/linux-arm64`   |
| macOS   | x86_64       | `@squick/darwin-x64`    |
| macOS   | arm64        | `@squick/darwin-arm64`  |
| Windows | x86_64       | `@squick/win32-x64`     |
